...
!!! info "Why this is less obvious than it looks"
...
Identical to [HiFi with an NCBI reference](hifi-ncbi-reference.md). There is no trace of
the BAM in `results/`; the sample looks the same as one given as FASTQ.

## Things to know

!!! warning "It must be an unaligned BAM"
