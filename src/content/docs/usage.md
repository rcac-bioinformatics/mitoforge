...
```bash
nextflow run . -profile negishi,apptainer -params-file results/pipeline_info/params_2026-01-01_12-00-00.json
```

Pin the pipeline version too:

```bash
nextflow run rcac-bioinformatics/mitoforge -r v0.1.0 -profile negishi,apptainer ...
```
